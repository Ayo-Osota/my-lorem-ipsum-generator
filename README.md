...
To view a live example, [click here](https://bala-blu.netlify.app/).
...
```bash
git clone https://github.com/Ayo-Osota/my-lorem-ipsum-generator.git
```

2.Starting the Client application.

```bash
cd my-lorem-ipsum-generator
